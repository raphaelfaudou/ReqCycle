 ...
 * @generated
 */
public class CustomDataModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CustomDataModelPackage.SPECIFICATION_TYPE: {
				SpecificationType specificationType = (SpecificationType)theEObject;
				T result = caseSpecificationType(specificationType);
				if (result == null) result = caseReachableSection(specificationType);
				if (result == null) result = caseContained(specificationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CustomDataModelPackage.REQUIREMENT_TYPE: {
				RequirementType requirementType = (RequirementType)theEObject;
				T result = caseRequirementType(requirementType);
				if (result == null) result = caseRequirementSection(requirementType);
				if (result == null) result = caseReachableObject(requirementType);
				if (result == null) result = caseReachableSection(requirementType);
				if (result == null) result = caseContained(requirementType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
