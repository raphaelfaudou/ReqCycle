...
public class RequirementSourcesConfPackageImpl extends EPackageImpl implements RequirementSourcesConfPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link RequirementSourcesConfPackage#eINSTANCE} when that field is accessed.
	...
	public static RequirementSourcesConfPackage init() {
		if (isInited) return (RequirementSourcesConfPackage)EPackage.Registry.INSTANCE.getEPackage(RequirementSourcesConfPackage.eNS_URI);
