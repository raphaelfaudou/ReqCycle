...
/**
 * This is the item provider adapter for a {@link RequirementSourceData.Scope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementSourceDataPackage.Literals.SCOPE__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementSourceDataPackage.Literals.SCOPE__NAME,
				 true,
				 false,
				 false,
