...
public class RequirementSourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RequirementSourceDataPackage.Literals.REQUIREMENT_SOURCE__REQUIREMENTS, RequirementSourceDataFactory.eINSTANCE.createSimpleRequirement()));

		newChildDescriptors.add(createChildParameter(RequirementSourceDataPackage.Literals.REQUIREMENT_SOURCE__REQUIREMENTS, RequirementSourceDataFactory.eINSTANCE.createRequirement()));
