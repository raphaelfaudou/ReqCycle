...
public class CheckBoxInputDialog extends AbstractCustomDialog {
    ...
    protected void createCustomDialogArea(Composite parent) {
        ...
        if (this.contentProvider == null) this.contentProvider = ArrayContentProvider.getInstance();
        if (this.labelProvider == null) this.labelProvider = this.getDefaultLabelProvider();
    ...
    protected void buttonPressed(int buttonId) {
        if (buttonId == IDialogConstants.OK_ID) {
            this.selectedItems.addAll(new ArrayList<Object>(
                    Arrays.asList(this.checkboxTableViewer.getCheckedElements())));
        } else {
