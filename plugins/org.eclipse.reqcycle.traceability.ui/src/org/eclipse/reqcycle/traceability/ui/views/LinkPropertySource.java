...
public class LinkPropertySource implements IPropertySource2 {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		List<EditableAttribute> editableAttributes = Lists
				.newArrayList(attributes.values());
		IPropertyDescriptor[] descriptors = new IPropertyDescriptor[editableAttributes
				.size()];
		for (int i = 0; i < editableAttributes.size(); i++) {
			descriptors[i] = new LinkPropertyDescriptor(
					editableAttributes.get(i));
		}
		return descriptors;
	}
