...
public class PredicatesConfPackageImpl extends EPackageImpl implements PredicatesConfPackage {
     ...
     * 
     * <p>This method is used to initialize {@link PredicatesConfPackage#eINSTANCE} when that field is accessed.
    ...
    public static PredicatesConfPackage init() {
        if (isInited) return (PredicatesConfPackage)EPackage.Registry.INSTANCE.getEPackage(PredicatesConfPackage.eNS_URI);
