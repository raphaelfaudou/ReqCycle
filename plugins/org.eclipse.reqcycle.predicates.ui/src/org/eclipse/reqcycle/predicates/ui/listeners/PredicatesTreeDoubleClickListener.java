...
public class PredicatesTreeDoubleClickListener implements IDoubleClickListener {
            ...
            if (predicate instanceof IEAttrPredicate) {
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    if (selection.getFirstElement() instanceof IEAttrPredicate) {
                        ...
                        Iterator<Entry<EStructuralFeature, Object>> iter = editionResult.getEditedEntries().entrySet()
                                .iterator();
     ...
     */
    private static EStructuralFeature getPredicateEStructuralFeature(final ITypedPredicate<?> typedPredicate,
