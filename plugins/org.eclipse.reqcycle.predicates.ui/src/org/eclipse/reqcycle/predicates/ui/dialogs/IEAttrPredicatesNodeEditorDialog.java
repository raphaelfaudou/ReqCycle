...
import org.eclipse.reqcycle.predicates.ui.components.PredicatePropsEditor;
import org.eclipse.reqcycle.predicates.ui.util.SWTUtil;
...
import org.eclipse.reqcycle.ui.eattrpropseditor.impl.SimpleEditionResult;
...
public class IEAttrPredicatesNodeEditorDialog extends Dialog {
        ...
        if (buttonId == IDialogConstants.OK_ID) {
            if (!editionValid()) {
                ...
                MessageDialog.openError(getShell(), "Error",
                        "Some errors occured during the edition of one or more properties.");
    ...
    /**
     * @return <code>true</code> if and only if all properties editors return <code>true</code> for
     *         {@link GenericEAttrPropsEditor#isEditionValid()}.
     */
        ...
        public boolean hasChildren(Object element) {
            if (element instanceof EClass) {
                ...
                while (iter.hasNext()) {
                    ...
                    if (eObj instanceof EOperation) iter.remove();
                }
                return copy.size() > 0;
