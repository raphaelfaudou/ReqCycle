 ...
 * @generated
 */
public class PredicatesActionBarContributor
    ...
    protected IAction showPropertiesViewAction =
        new Action(PredicatesUIPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
            @Override
            public void run() {
                try {
    ...
    protected IAction refreshViewerAction =
        new Action(PredicatesUIPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
            @Override
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(PredicatesUIPlugin.INSTANCE.getString("_UI_PredicatesEditor_menu"), "org.eclipse.reqcycle.predicates.core.apiMenuID");
