...
/**
 * This is the item provider adapter for a {@link org.eclipse.reqcycle.predicates.core.api.ContainsPatternPredicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainsPatternPredicateItemProvider
    ...
    private String getLabelForEditedPredicate(final ContainsPatternPredicate predicate) {
        ...
        if (typedElement instanceof EStructuralFeature) {
            ...
            label.append(((EStructuralFeature) typedElement).getName()).append(" ~ ")
                    .append(predicate.getExpectedPattern());
        }
