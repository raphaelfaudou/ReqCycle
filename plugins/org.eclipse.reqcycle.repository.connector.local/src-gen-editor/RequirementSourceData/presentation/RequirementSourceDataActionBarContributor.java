 ...
 * @generated
 */
public class RequirementSourceDataActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(RequirementSourceDataEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(RequirementSourceDataEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
