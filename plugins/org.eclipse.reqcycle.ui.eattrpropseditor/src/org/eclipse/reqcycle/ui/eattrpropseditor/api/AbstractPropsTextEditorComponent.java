...
public abstract class AbstractPropsTextEditorComponent<T> extends AbstractPropsEditorComponent<T> {
    ...
    private static final Image ERROR_IMAGE = FieldDecorationRegistry.getDefault()
    ...
    /**
     * @param textValue - The current text value entered into the {@link Text} widget.
    ...
    /**
     * @param textValue - The current text value entered into the {@link Text} widget.
     * @return <code>true</code> if the text value is valid according to the expected supported type, <code>false</code>
     *         otherwise.
     */
