...
public class EAttrPropsEditorPlugin implements BundleActivator {
     ...
     */
    public static IEAttrPropsEditor<?> getStructuralFeatureEditor(final EAttribute eAttr,
            final String javaClassTypeName, Composite container, int style) {
        ...
        try {
            ...
            for (final String currentSupportedType : getEAttrEditorManager().keySet()) {
                ...
                if (currentSupportedClass.isAssignableFrom(initialClass)) {
                    ...
                    if (nearestClass.getName().equals(type)) break;
                }
            }
