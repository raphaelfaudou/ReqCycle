...
public class DataModelActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DataModelEditorPlugin.INSTANCE.getString("_UI_DataModelEditor_menu"), "DataModelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(DataModelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(DataModelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void selectionChanged(SelectionChangedEvent event) {
		...
		if(selection instanceof IStructuredSelection && ((IStructuredSelection)selection).size() == 1) {
			...
			//			newChildDescriptors = getChildDescriptor(object);
	...
	//	private Collection<?> getChildDescriptor(Object object) {
	//		
	//		Set<EClass> eClasses = RequirementsEditorUtil.getDataEClasses(object);
	...
	//			try {
	//				newChildDescriptors.add(new CommandParameter(object, feature, reqCreator.addObject(eClass, "", "", "")));
	//			} catch (Exception e) {
	//				e.printStackTrace();
	//			}
	//		}
	...
	protected Collection<IAction> generateCreateChildActions(Collection<?> descriptors, ISelection selection) {
		if(selection instanceof IStructuredSelection) {
			if(((IStructuredSelection)selection).getFirstElement() instanceof RequirementSources) {
				return null;
			}
		}
